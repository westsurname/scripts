...
def get_completed_parent_directory(use_radarr, use_radarr4k, use_radarranime, use_sonarr, use_sonarr4k, use_sonarranime, custom_directory):
    if custom_directory:
...
def main():
    ...
    if args.directory or args.radarr or args.radarr4k or args.radarranime or args.sonarr or args.sonarr4k or args.sonarranime or args.symlink_directory:
        # Process once with the provided arguments and exit
        completedParentDirectory = get_completed_parent_directory(
            args.radarr, args.radarr4k, args.radarranime,
            args.sonarr, args.sonarr4k, args.sonarranime,
        ...
        while True:
            ...
            choice = input("Is this for Radarr, Radarr4K, RadarrAnime, Sonarr, Sonarr4K, or SonarrAnime? (r/r4k/ra/s/s4k/sa): ").strip().lower()
            
            radarr, radarr4k, radarranime, sonarr, sonarr4k, sonarranime = False, False, False, False, False, False
            ...
            completedParentDirectory = get_completed_parent_directory(
                radarr, radarr4k, radarranime,
                sonarr, sonarr4k, sonarranime,
                None
            )
            if not completedParentDirectory:
